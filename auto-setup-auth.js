...
// ⚠️ REMPLACEZ CETTE LIGNE AVEC VOTRE VRAIE CLÉ API
const API_KEY = "YOUR_SERVER_API_KEY_HERE";
...
async function setupDatabase() {
    ...
    if (API_KEY === "YOUR_SERVER_API_KEY_HERE") {
        console.log("❌ Veuillez remplacer YOUR_SERVER_API_KEY_HERE par votre vraie clé API");
        console.log("🔑 Générez une clé API depuis: https://fra.cloud.appwrite.io/console");
        console.log("📋 Scopes requis: databases.*, collections.*, attributes.*, indexes.*");
        return;
    }
